...
(define metadata
  '((version . "0.1.0")
    ...
    (repo . "github.com/hyperpolymath/broad-spectrum")))
...
(define project-context
  '((name . "broad-spectrum")
    (tagline . "A comprehensive CLI website auditor built with ReScript, Deno, and TypeScript. Performs automated security, accessibility, performance, and SEO audits on websites.")
    (version . "0.1.0")
