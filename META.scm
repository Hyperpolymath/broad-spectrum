...
(define-module (broad-spectrum meta)
...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "A comprehensive CLI website auditor built with ReScript, Deno, and TypeScript. Performs automated security, accessibility, performance, and SEO audits on websites.")
...
(define development-practices
  '((code-style
     (languages . ("Just" "Nix" "ReScript" "Scheme" "TypeScript"))
